...
--compare the average purchase amountes between standard and express shipping.
...
--which 5 products have the highest percentage of purchases with discount applies?
select top 5 item_purchased ,
